...
public class table3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        columnBinding.setColumnName("D.O.B");
        ...
        columnBinding.setColumnClass(String.class);
        columnBinding.setEditable(false);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${quota}"));
        columnBinding.setColumnName("QUOTA");
        columnBinding.setColumnClass(String.class);
        columnBinding.setEditable(false);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${joiningYear}"));
        columnBinding.setColumnName("JOINING YEAR");
